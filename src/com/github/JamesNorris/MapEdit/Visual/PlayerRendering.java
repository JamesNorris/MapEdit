...
public class PlayerRendering {
	...
	public static ArrayList<MapCursor> mapcurs = new ArrayList<MapCursor>();
	public static int b, f, C, d;
	public static boolean armed;

	public static void renderPlayerCursor(MapView map, MapCanvas canvas, Player player) {
